...
raw_img_file = '../prevampire/prevampire/tests/data/rawimgtif/'
input_file = '../prevampire/prevampire/tests/data/input/'
output_file = '../prevampire/prevampire/tests/data/output/'
...
def test_take_channel():
    ...
    img = np.array(img)
    name = np.array(name)
    img_assert = np.load('../prevampire/prevampire/tests/data/assertdata/denoised_img_arr.npy')
    name_assert = np.load('../prevampire/prevampire/tests/data/assertdata/denoised_names.npy')
...
def test_save_npy():
    imgs = np.load('../prevampire/prevampire/tests/data/assertdata/denoised_img_arr.npy')
    name = np.load('../prevampire/prevampire/tests/data/assertdata/denoised_names.npy')
...
def test_apply_threshold():
    ...
    seg2 = np.load('../prevampire/prevampire/tests/data/assertdata/threshli_img_arr.npy')
    name2 = np.load('../prevampire/prevampire/tests/data/assertdata/threshli_names.npy')
...
def test_skeletonize_images():
    imgs = np.load('../prevampire/prevampire/tests/data/assertdata/threshli_img_arr.npy')
    name = np.load('../prevampire/prevampire/tests/data/assertdata/denoised_names.npy')

    skel1, name1 = pv.skeletonize_images(imgs, name)

    skel2 = np.load('../prevampire/prevampire/tests/data/assertdata/skel_img_arr.npy')
    name2 = np.load('../prevampire/prevampire/tests/data/assertdata/skel_names.npy')
...
def test_load_npy_imgs():
    copy_tree('../prevampire/prevampire/tests/data/denoisednpy', input_file)
...
def test_load_tif_imgs():
    copy_tree('../prevampire/prevampire/tests/data/denoisedtif', input_file)
...
def test_get_skel_df():
    imgs = np.load('../prevampire/prevampire/tests/data/assertdata/skel_img_arr.npy')
    name = np.load('../prevampire/prevampire/tests/data/assertdata/skel_names.npy')

    df1 = pv.get_skel_df(imgs, name)

    df2 = pd.read_csv('../prevampire/prevampire/tests/data/assertdata/skel_df.csv')
